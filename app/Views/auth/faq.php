...
<main class="auth-shell faq-shell">
    <section class="login-card faq-card">
        ...
        <p class="helper">Baca jawaban singkat sebelum masuk ke ChiliBooks. Ketuk item untuk membuka detailnya.</p>
        ...
        <a class="faq-back-link" href="<?= site_url('login') ?>">← Kembali ke Login</a>
    </section>
</main>
<?= $this->endSection() ?>
